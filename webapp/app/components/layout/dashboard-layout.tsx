        ...
        cn(
          ...
          minimal
            ...
            : compact
              ...
              : "gap-3 px-4 py-3",
          isActive &&
            "border-transparent bg-[var(--brand-primary)] text-[var(--brand-on-primary)] shadow-[0_10px_35px_rgba(18,199,127,0.24)]"
        )
      }
    >
      <HugeiconsIcon
  ...
  return (
    <div className="relative min-h-svh overflow-hidden bg-[#FDFBF7] text-[#2F3E36]">
      <div className="pointer-events-none fixed inset-0">
        ...
        <div className="absolute bottom-12 right-[-4rem] h-72 w-72 rounded-full bg-[var(--brand-primary)]/18 blur-3xl" />
      </div>
      ...
      <div className="relative z-10 min-h-svh">
        ...
        <aside className="fixed left-6 top-1/2 z-30 hidden w-20 -translate-y-1/2 rounded-[2rem] border border-white/40 bg-white/44 p-3 shadow-[0_18px_70px_rgba(47,62,54,0.1)] backdrop-blur-xl md:flex md:flex-col md:items-center md:justify-between md:gap-4">
          <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[var(--brand-primary)] text-sm font-semibold text-[var(--brand-on-primary)] shadow-[0_12px_25px_rgba(18,199,127,0.28)]">
            EF
          </div>
              ...
              <div className="flex items-center justify-between gap-3 pt-1">
                ...
                <div className="flex-1">
                  <button
                    ...
                    onMouseEnter={prepareVoiceModal}
                    onClick={() => setIsVoiceModalOpen(true)}
                    className="mx-auto flex h-10 w-10 items-center justify-center rounded-full bg-[var(--brand-primary)] text-[var(--brand-on-primary)] shadow-[0_12px_24px_rgba(18,199,127,0.22)] transition-colors hover:bg-[var(--brand-primary-strong)]"
                    aria-label="Open voice conversation"
                  >
                    <HugeiconsIcon icon={Mic01Icon} size={18} strokeWidth={1.8} />
                  </button>
